...
pub  fn exprs_1(a: f64, b: f64, c: f64, d: f64, e: f64, f: f64, g: f64, h: f64) -> f64 {
    ...
    ((-1.0000000000000000000_f64) * (((c) + (d)).signum())) + (((a) + ((-1.0000000000000000000_f64) * (b))).signum())
...
pub  fn exprs_4(a: f64, b: f64, c: f64, d: f64, e: f64, f: f64, g: f64, h: f64) -> f64 {
    ...
    ((-1.0000000000000000000_f64) * (((a) + (h)).exp())) + ((d) * ((e).recip()) * ((a) + (b) + ((-1.0000000000000000000_f64) * (c)))) + ((((-1.0000000000000000000_f64) * (h)) + ((f) * (g))).ln())
